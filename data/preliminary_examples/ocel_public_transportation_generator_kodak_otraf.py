...
df_stops = pd.read_csv('/Users/johannesengelhardt/PycharmProjects/Masterthesis3/GTFS-OTRAF-2026-05-04/stops.txt', sep="\t")
df_stop_times = pd.read_csv('/Users/johannesengelhardt/PycharmProjects/Masterthesis3/GTFS-OTRAF-2026-05-04/stop_times.txt', sep="\t")
df_routes = pd.read_csv('/Users/johannesengelhardt/PycharmProjects/Masterthesis3/GTFS-OTRAF-2026-05-04/routes.txt',  encoding="latin1", sep="\t")
df_agency = pd.read_csv('/Users/johannesengelhardt/PycharmProjects/Masterthesis3/GTFS-OTRAF-2026-05-04/agency.txt', sep="\t")
df_calendar_dates = pd.read_csv('/Users/johannesengelhardt/PycharmProjects/Masterthesis3/GTFS-OTRAF-2026-05-04/calendar_dates.txt', sep="\t")
df_trips = pd.read_csv('/Users/johannesengelhardt/PycharmProjects/Masterthesis3/GTFS-OTRAF-2026-05-04/trips.txt', sep="\t")
...
with open("ocel2.json", "w", encoding="utf-8") as f:
    ...
    print(tabulate(data.events.head(100),headers="keys", tablefmt="psql"))
