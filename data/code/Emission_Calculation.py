...
EMISSION_OUTPUT_DIR = Path("thesis-main/figures/Emission_Experiment_2026_05_04")
EMISSION_OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

# Load data.
aux_event_log_overview = pd.read_csv(
    f"aux_event_log_overview_kodak_{DATASET_DATE}.csv",
    dtype={
        "vehicle_id": "string",
        "trip_id": "string",
        "trip_id_org": "string",
...
trip_segment_summary.to_csv(f"trip_segment_summary_{DATASET_DATE}.csv", index=False)
trip_consumption_emission_summary.to_csv(
    f"trip_consumption_emission_summary_{DATASET_DATE}.csv",
    index=False
)
route_consumption_emission_summary.to_csv(
    f"route_consumption_emission_summary_{DATASET_DATE}.csv",
    index=False
)
top_segment_emission_summary.to_csv(
    f"top_segment_emission_summary_{DATASET_DATE}.csv",
    index=False
)
top10_segments_biogas_experiment.to_csv(
    f"top10_segments_biogas_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_performing_segments_biogas_experiment.to_csv(
    f"top10_performing_segments_biogas_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_trips_biogas_experiment.to_csv(
    f"top10_trips_biogas_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_performing_trips_biogas_experiment.to_csv(
    f"top10_performing_trips_biogas_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_grouped_segments_mode_experiment.to_csv(
    f"top10_grouped_segments_mode_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_performing_grouped_segments_mode_experiment.to_csv(
    f"top10_performing_grouped_segments_mode_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_grouped_trips_mode_experiment.to_csv(
    f"top10_grouped_trips_mode_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_performing_grouped_trips_mode_experiment.to_csv(
    f"top10_performing_grouped_trips_mode_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_grouped_segments_single_factor_experiment.to_csv(
    f"top10_grouped_segments_single_factor_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_performing_grouped_segments_single_factor_experiment.to_csv(
    f"top10_performing_grouped_segments_single_factor_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_grouped_trips_single_factor_experiment.to_csv(
    f"top10_grouped_trips_single_factor_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_performing_grouped_trips_single_factor_experiment.to_csv(
    f"top10_performing_grouped_trips_single_factor_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_grouped_segments_occupancy_mode_experiment.to_csv(
    f"top10_grouped_segments_occupancy_mode_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_performing_grouped_segments_occupancy_mode_experiment.to_csv(
    f"top10_performing_grouped_segments_occupancy_mode_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_grouped_trips_occupancy_mode_experiment.to_csv(
    f"top10_grouped_trips_occupancy_mode_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_performing_grouped_trips_occupancy_mode_experiment.to_csv(
    f"top10_performing_grouped_trips_occupancy_mode_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_grouped_segments_delay_aware_experiment.to_csv(
    f"top10_grouped_segments_delay_aware_experiment_{DATASET_DATE}.csv",
    index=False,
)
top100_segments_delay_aware_experiment.to_csv(
    f"top100_segments_delay_aware_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_performing_grouped_segments_delay_aware_experiment.to_csv(
    f"top10_performing_grouped_segments_delay_aware_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_grouped_trips_delay_aware_experiment.to_csv(
    f"top10_grouped_trips_delay_aware_experiment_{DATASET_DATE}.csv",
    index=False,
)
top10_performing_grouped_trips_delay_aware_experiment.to_csv(
    f"top10_performing_grouped_trips_delay_aware_experiment_{DATASET_DATE}.csv",
    index=False,
)
segment_anomaly_score_summary.to_csv(
    f"segment_anomaly_score_summary_{DATASET_DATE}.csv",
    index=False
)
...
trip_anomaly_score_summary.to_csv(
    f"trip_anomaly_score_summary_{DATASET_DATE}.csv",
    index=False,
)
...
\\begin{{figure}}[H]
    \\centering
    \\includegraphics[width=0.85\\textwidth]{{thesis-main/figures/Emission_Experiment_2026_05_04/segment_emission_histogram_{DATASET_DATE}.png}}
...
\\begin{{figure}}[H]
    \\centering
    \\includegraphics[width=0.85\\textwidth]{{thesis-main/figures/Emission_Experiment_2026_05_04/segment_emission_boxplot_{DATASET_DATE}.png}}
...
(EMISSION_OUTPUT_DIR / f"segment_emission_analysis_{DATASET_DATE}.tex").write_text(
    segment_emission_analysis_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"emission_analysis_tables_only_{DATASET_DATE}.tex").write_text(
    emission_analysis_tables_only_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"segment_level_tables_only_{DATASET_DATE}.tex").write_text(
    segment_level_tables_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"trip_level_tables_only_{DATASET_DATE}.tex").write_text(
    trip_level_tables_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_grouped_segments_mode_experiment_{DATASET_DATE}.tex").write_text(
    top10_mode_segment_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_performing_grouped_segments_mode_experiment_{DATASET_DATE}.tex").write_text(
    top10_performing_mode_segment_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_grouped_trips_mode_experiment_{DATASET_DATE}.tex").write_text(
    top10_mode_trip_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_performing_grouped_trips_mode_experiment_{DATASET_DATE}.tex").write_text(
    top10_performing_mode_trip_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_grouped_segments_single_factor_experiment_{DATASET_DATE}.tex").write_text(
    top10_single_factor_segment_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_performing_grouped_segments_single_factor_experiment_{DATASET_DATE}.tex").write_text(
    top10_performing_single_factor_segment_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_grouped_trips_single_factor_experiment_{DATASET_DATE}.tex").write_text(
    top10_single_factor_trip_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_performing_grouped_trips_single_factor_experiment_{DATASET_DATE}.tex").write_text(
    top10_performing_single_factor_trip_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_grouped_segments_occupancy_mode_experiment_{DATASET_DATE}.tex").write_text(
    top10_occupancy_mode_segment_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_performing_grouped_segments_occupancy_mode_experiment_{DATASET_DATE}.tex").write_text(
    top10_performing_occupancy_mode_segment_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_grouped_trips_occupancy_mode_experiment_{DATASET_DATE}.tex").write_text(
    top10_occupancy_mode_trip_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_performing_grouped_trips_occupancy_mode_experiment_{DATASET_DATE}.tex").write_text(
    top10_performing_occupancy_mode_trip_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_grouped_segments_delay_aware_experiment_{DATASET_DATE}.tex").write_text(
    top10_delay_aware_segment_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top100_segments_delay_aware_experiment_{DATASET_DATE}.tex").write_text(
    top100_delay_aware_segment_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_performing_grouped_segments_delay_aware_experiment_{DATASET_DATE}.tex").write_text(
    top10_performing_delay_aware_segment_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_grouped_trips_delay_aware_experiment_{DATASET_DATE}.tex").write_text(
    top10_delay_aware_trip_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"top10_performing_grouped_trips_delay_aware_experiment_{DATASET_DATE}.tex").write_text(
    top10_performing_delay_aware_trip_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"route_level_tables_only_{DATASET_DATE}.tex").write_text(
    route_level_tables_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"segment_emission_per_km_tables_only_{DATASET_DATE}.tex").write_text(
    segment_emission_per_km_tables_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"trip_emission_per_km_tables_only_{DATASET_DATE}.tex").write_text(
    trip_emission_per_km_tables_latex,
    encoding="utf-8",
)

(EMISSION_OUTPUT_DIR / f"railway_emission_tables_only_{DATASET_DATE}.tex").write_text(
    railway_tables_latex,
    encoding="utf-8",
)
...
plt.tight_layout()
plt.savefig(
    EMISSION_OUTPUT_DIR / f"segment_emission_histogram_{DATASET_DATE}.png",
    dpi=300
)
plt.close()
...
plt.tight_layout()
plt.savefig(
    EMISSION_OUTPUT_DIR / f"segment_emission_boxplot_{DATASET_DATE}.png",
    dpi=300
)
plt.close()
...
plt.tight_layout()
plt.savefig(
    EMISSION_OUTPUT_DIR / f"constant_speed_emission_comparison_{DATASET_DATE}.png",
    dpi=300,
    bbox_inches="tight",
)
plt.close()
...
constant_speed_error_bin_summary.to_csv(
    EMISSION_OUTPUT_DIR / f"constant_speed_percentage_error_by_distance_bin_{DATASET_DATE}.csv",
    index=False,
)
...
plt.tight_layout()
plt.savefig(
    EMISSION_OUTPUT_DIR / f"constant_speed_percentage_error_by_distance_bin_{DATASET_DATE}.png",
    dpi=300,
    bbox_inches="tight",
)
plt.close()
